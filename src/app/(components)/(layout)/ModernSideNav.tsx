...
import { Gamepad2, Plus, X, Home, LayoutDashboard } from "lucide-react";
import { ExIconTrophy, ExIconLogo } from "@/app/(components)/ui";
...
export default function ModernSideNav({ visible = true, onClose }: ModernSideNavProps) {
