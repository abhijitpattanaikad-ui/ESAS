...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 z-0 left-0 right-0 h-[200px] bg-linear-to-t from-woodsmoke-950 via-woodsmoke-950/60 to-transparent pointer-events-none"></div>
    </motion.section>
  );
}

// -------------------- 🎨 Image Asset References --------------------
const HERO_CHARACTER_IMG = "/images/hero-model.webp";