...
export default function Advantages() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 z-0 left-0 right-0 h-[40%] bg-linear-to-t from-woodsmoke-950 via-via-woodsmoke-950/60 to-transparent pointer-events-none"></div>
    </section>
  );
}